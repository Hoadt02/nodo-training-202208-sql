...
//        buildPdfMetadata(map, document, httpServletRequest);
    ...
    protected abstract void buildPdfDocument(Map<String, Object> map, Document document, PdfWriter pdfWriter, HttpServletRequest request, HttpServletResponse response) throws DocumentException;
}
